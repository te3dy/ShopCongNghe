	...
	<div class="row">
		<div class="col-md-12 g-my-20">
			...
			<a style="color: #0f7af2; font-weight: bold; font-style: italic">Bước
				...
				khoản trên website, hãy thực hiện thao tác <a
				href="client/DangKy.jsp" style="font-size: 17px">tạo tài khoản</a>
			</a> <br /> <br /> <a
				style="color: #0f7af2; font-weight: bold; font-style: italic;">Bước
				2: Chọn sản phẩm</a> <br /> <a style="color: black; font-size: 17px">-
				Sử dụng công cụ tìm kiếm để tìm sản phẩm mà bạn cần</a><br /> <a
				style="color: black; font-size: 17px">- Click chuột vào nút Mua
				ngay để mua sản phẩm</a><br /> <a style="color: black; font-size: 17px">-
			...
			<a style="color: black; font-size: 17px">2. Chuyển khoản qua ngân
				...
				khi chuyển tiền vui lòng gọi điện về số 0165 476 3250 để xác nhận.</a><br />
			<br /> <a
				style="color: #0f7af2; font-weight: bold; font-style: italic">Bước
				...
				có bất cứ khó khăn nào hãy gọi: 0165 476 3250</a><br />
		</div>
	</div>
</div>
